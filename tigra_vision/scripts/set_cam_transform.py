# based on https://www.intelrealsense.com/how-to-multiple-camera-setup-with-ros/
# Step 1: Obtaining the camera serial numbers.
# Step 2: Start both cameras.
# Step 3: Publish spatial connection between cameras.
# python src/realsense/realsense2_camera/scripts/set_cams_transforms.py cam_1_link cam_2_link 0.7 0.6 0 -90 0 0
...
if __name__ == '__main__':
    ...
    while True:
        ...
        try:
            ...
            # print('kk is %s key_idx is %d' % (kk,key_idx))
            # print(status.keys()[kk])
            status['mode'] = list(status)[key_idx]
